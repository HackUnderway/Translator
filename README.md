# Translator
Translator made in Flask, to translate texts in Spanish and English. 💬
...
<img src="https://github.com/HackUnderway/Translator/blob/main/img/Flask.png" title="Translator">
<img src="https://github.com/HackUnderway/Translator/blob/main/img/English.png" title="Translator">
<img src="https://github.com/HackUnderway/Translator/blob/main/img/Spanish.png" title="Translator">
...
# USAGE
```
git clone https://github.com/HackUnderway/Translator.git
```
```
cd Translator
```
...
# LICENSE
- [x] Translator is licensed. 
- [x] See [LICENSE](https://github.com/HackUnderway/Translator#MIT-1-ov-file) for more information.
